Sub Main
	...
	BF1Q.Text = "SELECT Unionall(Buffer([WaterWays].[Geom (I)], 100, ""ft"")) into BF1T FROM [WaterWays]"
	BF1Q.Run
	BF2Q.Text = "SELECT UnionAll(Buffer([WaterWays].[Geom (I)], 1000, ""ft"")) into BF2T FROM [WaterWays]"
	BF2Q.Run
	BF3Q.Text = "SELECT UnionAll(Buffer([WaterWays].[Geom (I)], 2000, ""ft"")) into BF3T FROM [WaterWays]"
	BF3Q.Run
	Set BF1T = CompS("BF1T")
	Set BF2T = CompS("BF2T")
	Set BF3T = CompS("BF3T")
